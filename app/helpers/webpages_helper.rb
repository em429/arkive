module WebpagesHelper
  ...
  def toggle_read_status_button(webpage)
    if webpage.read_status?
      link_to 'Mark Unread', mark_unread_path(webpage), class: 'btn-primary'
    else
      link_to 'Mark Read', mark_read_path(webpage), class: 'btn-primary'
    end
  end
